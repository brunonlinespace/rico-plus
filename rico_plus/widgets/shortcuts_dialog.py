...
"""Ricopad-style searchable keyboard-shortcuts reference."""
...
class ShortcutsDialog(QDialog):
    """Show real assigned shortcuts in Ricopad's filtered table style."""
    ...
    def __init__(
        ...
        self.setWindowTitle("Keyboard Shortcuts — Rico Plus")
        ...
        self.category.setAccessibleName("Shortcut category")
